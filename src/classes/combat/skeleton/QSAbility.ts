...
export class QSAbility{
    ...
    constructor(scene:Scene, x:number, y:number){
        this.hitbox = new SAT.Box(new SAT.Vector(x, y-2), 48, 4);
    ...
    debug(x:number, y:number){
        ...
        this.hitbox.pos = new SAT.Vector(x, y);
        ...
        hitbox.rotate(direction.angle())
        this.drawLines(hitbox, hitbox.calcPoints);
    }
